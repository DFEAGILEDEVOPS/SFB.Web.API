...
namespace SFB.Web.Api.Controllers
{
    ...
    public class SelfAssessmentController : ControllerBase
    {
        ...
        private async Task<List<string>> GetAllAvailableTermYears(
            EstablishmentType establishmentType = EstablishmentType.Maintained)
        {
            var latestMaintainedTerm =
                await _financialDataService.GetLatestDataYearPerEstabTypeAsync(establishmentType);
